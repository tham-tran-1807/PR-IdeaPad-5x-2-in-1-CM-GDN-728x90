...
lib.ssMetadata = [
		{name:"PR_IdeaPad_5x_2_in_1_CM_GDN_728x90_atlas_1", frames: [[971,358,50,50],[0,0,728,90],[716,92,298,90],[725,358,244,87],[657,184,333,90],[427,276,296,90],[0,276,425,90],[730,0,287,90],[725,276,284,80],[0,184,655,90],[0,92,714,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_5x_2_in_1_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPad5x2in1CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(212,10);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(251).to({_off:false},0).to({_off:true},49).wait(90));

	// F5
	this.instance_4 = new lib.F5();
	this.instance_4.setTransform(75,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(200).to({_off:false},0).to({_off:true},51).wait(139));

	// F4
	this.instance_5 = new lib.F4();
	this.instance_5.setTransform(171,0);
	...
	this.instance_6.setTransform(149,0);
	...
	this.instance_7.setTransform(212,1);
...
// library properties:
lib.properties = {
	id: '5A10E3B09BE4E746A69902FBA54A7B7D',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_5x_2_in_1_CM_GDN_728x90_atlas_1.png", id:"PR_IdeaPad_5x_2_in_1_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['5A10E3B09BE4E746A69902FBA54A7B7D'] = {
